...
from utils.camera_utils import cameraList_from_camInfos, cameraList_from_camInfos2, camera_to_JSON
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        for resolution_scale in resolution_scales:
            ...
            if not self.loaded_iter:
                self.train_cameras[resolution_scale] = cameraList_from_camInfos2(scene_info.train_cameras, resolution_scale, args, scene_info.point_cloud)
            else:
